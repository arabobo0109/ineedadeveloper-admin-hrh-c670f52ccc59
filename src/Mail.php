...
class Mail {
     ...
     * @return  bool
     */
        public static function send($to, $subject, array $view_data, $view_name = "basic", $from = null, array $attachments = [],$replyToEmail=null,$replyToName=null) {
            if (env('APP_URL')=='http://amg.signer') {
                return true;
            }
//            if (env('APP_URL')=='http://amg.signer' && $to!='muellerunity@gmail.com' && $to!='worklceo@gmail.com' && $to!='muellerunity@gmail.com' && $to!='muellerunity@gmail.com' && $to!='muellerunity@gmail.com' && $to!='muellerunity@gmail.com' && $to!='muellerunity@gmail.com' && $to!='muellerunity@gmail.com') {
//                return true;
//            }
        $mail = new PHPMailer;
        $mail->CharSet = 'UTF-8';
