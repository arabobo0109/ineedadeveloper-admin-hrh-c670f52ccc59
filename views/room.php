...
<!--                        <td></td>-->
                        ...
                        <td>
                            <a class="send-to-server-click"  data="bedid:{{ $bed_item->id }}|status:Maintenance|csrf-token:{{ csrf_token() }}" url="<?=url("Room@ChangeBedStatus");?>"  warning-button="Continue" loader="true" href="" warning-title="Are you sure?"
                                warning-message="This Bed status will change to Maintenance.">Set Maintenance
                            </a>
                        </td>
                    </tr>
                    @endforeach
                ...
                <div class="bed-statitic">
                    ...
                    <div class="color-created">
                        <span>Created : </span>
                        <span>{{ $bed_statistic['created_count'] }} ({{ $bed_statistic['created_percent'] }}%)</span>
                    </div>
                    <div class="color-red">
