 ...
 * ==========================================================
 *
 * Library of static html components for the admin area. This file must not be executed directly. � 2017-2023 akio.support. All rights reserved.
 *
 */
...
<div class="sb-profile-box sb-lightbox">
    <div class="sb-top-bar">
        ...
        <div>
            ...
            <?php if (sb_get_multi_setting('sms', 'sms-user')) echo '<a data-value="sms" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send text message') . '"><i class="sb-icon-sms"></i></a>' ?>
            <?php if (defined('SB_WHATSAPP') && (!function_exists('sb_whatsapp_active') || sb_whatsapp_active())) echo '<a data-value="whatsapp" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send a WhatsApp message template') . '"><i class="sb-icon-social-wa"></i></a>' // Deprecated: remove function_exists('sb_whatsapp_active') ?>
...
function sb_login_box() { ?>
    <form class="sb sb-rich-login sb-admin-box">
        ...
        <div class="sb-top-bar">
            ...
            <div class="sb-text"><?php echo sb_get_setting('login-message', defined('SB_WP') ? sb_('Please insert email and password of your WordPress account') : sb_('Enter your login details below')) ?></div>
        </div>
        <div class="sb-main">
    ...
    <div class="sb-lightbox sb-updates-box">
        ...
        <div class="sb-main sb-scroll-area">
            <div class="sb-bottom">
                ...
                <a href="https://akio.support/changes" target="_blank" class="sb-btn-text">
    ...
    <div class="sb-lightbox sb-direct-message-box">
        ...
        <div class="sb-main sb-scroll-area">
            ...
            <div class="sb-bottom">
                ...
                <div></div>
                <a class="sb-btn-text" target="_blank" href="https://akio.support/docs#direct-message"><i class="sb-icon-help"></i></a>
            </div>
        </div>
    </div>
<?php } ?>
...
function sb_component_admin() {
    ...
    <div class="sb-main <?php echo $css_class ?>" style="opacity: 0">
        <?php if ($logged) { ?>
                <div class="sb-header">
                    ...
                    <div class="sb-admin-nav-right sb-menu-mobile">
                        ...
                        <div class="sb-mobile">
                            <?php if ($is_admin || sb_get_multi_setting('agents', 'agents-edit-user') || ($supervisor && $supervisor['supervisor-edit-user'])) echo '<a href="#" class="edit-profile">' . sb_('Edit profile') . '</a>' ?>
                            ...
                            <div class="sb-conversation">
                                ...
                                <div class="sb-no-conversation-message">
                                    <div>
                                        ...
                                        <p>
                                            <?php sb_e('start a new conversation from the users area.') ?>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="sb-scroll-area">
                                    ...
                                    <?php if (!sb_get_setting('disable-tags')) echo '<div class="sb-panel-details sb-panel-tags"><i class="sb-icon-settings"></i><h3>' . sb_('Tags') . '</h3><div></div></div>' ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="sb-menu-wide sb-menu-users">
                                            ...
                                            <ul>
                                                ...
                                                <?php if ($is_admin || sb_get_setting('admin-agents-tab') || sb_get_multi_setting('agents', 'agents-tab') || ($supervisor && sb_get_multi_setting('supervisor', 'supervisor-agents-tab'))) {
                                        ...
                                        <div class="sb-menu-mobile">
                                            ...
                                            <ul>
                                                ...
                                                <?php if ($sms) echo '<li><a data-value="sms" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send a text message') . '"><i class="sb-icon-sms"></i></a><li>' ?>
                                                <?php if (defined('SB_WHATSAPP') && (!function_exists('sb_whatsapp_active') || sb_whatsapp_active())) echo '<li><a data-value="whatsapp" class="sb-btn-icon" data-sb-tooltip="' . sb_('Send a WhatsApp message template') . '"><i class="sb-icon-social-wa"></i></a><li>' // Deprecated: remove function_exists('sb_whatsapp_active') ?> 
                                                                            <li>
                ...
                if (defined('SB_WHATSAPP')) sb_whatsapp_send_template_box();
        ...
        <?php } else {
            echo "<script> location.href='/signin/?secure=true'; </script>";
            exit;
            sb_login_box();
        } ?>
