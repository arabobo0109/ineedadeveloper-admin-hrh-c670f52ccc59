 ...
 * ==========================================================
 *
 * Main JavaScript file. This file is shared by frond-end and back-end. © 2017-2023 akio.support. All rights reserved.
 * 
 */
    ...
    */
    ...
    var SBChat = {
        ...
        followUpCheck: function () {
            return !admin && this.conversation && CHAT_SETTINGS.follow && activeUser() && !activeUser().get('email') && SBF.storageTime('email', 24) && (CHAT_SETTINGS.office_hours || !CHAT_SETTINGS.follow['disable-office-hours']);
        },
        ...
        registration: function (check = false, type = CHAT_SETTINGS.registration_required) {
            if (check) return CHAT_SETTINGS.registration_required && (!CHAT_SETTINGS.registration_offline || !agents_online) && (!CHAT_SETTINGS.registration_timetable || !CHAT_SETTINGS.office - hours) && (activeUser() === false || ['visitor', 'lead'].includes(activeUser().type));
