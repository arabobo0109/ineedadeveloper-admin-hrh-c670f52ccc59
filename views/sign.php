                        ...
                        <div id="history" class="tab-pane fade in active">
                            ...
                            <div class="timeline">
                                ...
                                <ul>
                                    ...
                                    <li class="{{ $history->type }}"><em class="text-xs">{{ setToUserTimezone($history->time_) }}</em> {{ $history->activity }}</li>
                                    @endforeach
                                </ul>
                                <div class="circle"></div>
                            </div>
             ...
             <div class='chat-message chat-list'>
                ...
                @foreach ( $chats as $chat )
                 <div
                    ...
                    class="chat-message chat-message-sender"
                    @else
                    class="chat-message chat-message-recipient"
                    @endif
                     id="{{ $chat->id }}">
                       ...
                       <div class='chat-message-wrapper'>
                          ...
                          <div class='chat-details'>
                             <span class='chat-message-localization font-size-small'>{{ setToUserTimezone($chat->time_) }}</span>
                          </div>
                       </div>
                    </div>
                @endforeach
