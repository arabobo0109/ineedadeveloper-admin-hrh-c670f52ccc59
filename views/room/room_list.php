...
<!--                            <a class="btn btn-primary" href="--><?//=url("Room@reviewRoom");?><!--{{$item->id}}">Open Door</a>-->
                            ...
                            <a class="send-to-server-click btn btn-success" data="roomid:{{ $item->id }}|table:rooms|csrf-token:{{ csrf_token() }}" url="<?=url("Room@delete");?>" warning-title="Are you sure?" warning-message="This Room will be deleted." warning-button="Continue" loader="true" >Delete</a>
                        </td>
                    </tr>
                    @endforeach
                    @else
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <input type="text" class="form-control" id="room_name" placeholder="Room Number" data-parsley-required="true" name="name">
