...
/*
 * AJAX functions. This file must be executed only via AJAX. © 2017-2023 akio.support. All rights reserved.
 */
...
function sb_ajax_execute() {
    ...
    if (!defined('SB_API') && sb_security($function) !== true) {
        die(sb_json_response(new SBError('security-error', $function)));
    }
    switch ($function) {
        case 'get-user-by':
        ...
        case 'whatsapp-get-templates':
            return sb_json_response(sb_whatsapp_cloud_get_templates(sb_post('business_account_id')));
        ...
        case 'update-tags':
            return sb_json_response(sb_tags_update($_POST['conversation_id'], $_POST['tags'], sb_post('add')));
        case 'get-tags':
