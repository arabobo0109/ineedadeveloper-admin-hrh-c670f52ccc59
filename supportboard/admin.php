...
<head>
    ...
    <?php
    if (sb_get_multi_setting('grammarly', 'grammarly-active')) {
        echo '<script src="https://unpkg.com/@grammarly/editor-sdk?clientId=' . sb_get_multi_setting('grammarly', 'grammarly-client-id') . '"></script>';
    }
    ?>
