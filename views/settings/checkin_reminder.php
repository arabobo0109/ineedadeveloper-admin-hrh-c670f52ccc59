                            ...
                            <div class="panel-body">
                                <div class="remider-item">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>Days Before Lease {{$index==0?'Start':'End'}} Date.</label>
                                                <input class="form-control" name="days[]" min="1" placeholder="Days Before Lease Start Date." required type="number" value="{{ $reminder->days }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
