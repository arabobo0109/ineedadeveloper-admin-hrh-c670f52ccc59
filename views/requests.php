...
<body>
    ...
    <div class="content">
        <div class="page-title">
            ...
            <p>All pending, Signed Lease requests</p>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <table id="signer-datatable" class="table display companies-list">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong>Requested: </strong>{{ setToUserTimezone($request['data']->send_time) }}                                   @if ( $request['data']->status != "Pending" )
                                    <br><strong>Signed: </strong>{{ setToUserTimezone($request['data']->update_time) }}
                                    @endif
                                </td>
                                <td class="text-center">
...
Please sign with the Lease request document which we had sent earlier.
