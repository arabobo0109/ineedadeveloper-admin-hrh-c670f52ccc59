...
<header>
    ...
    <ul class="nav header-links pull-right">
        ...
        <li class="m-o">
            <button class="btn btn-success accept-request"><i class="ion-ios-checkmark-outline"></i> <span>Start</span>
            </button>
        </li>
<!--        <li class="m-o">-->
<!--            <button class="btn btn-danger send-to-server-click"-->
<!--                    data="requestid:{{ $request->id }}|file:{{ $document->id }}|csrf-token:{{ csrf_token() }}"-->
<!--                    url="--><?//= url("Guest@decline"); ?><!--" warning-title="Are you sure?"-->
<!--                    warning-message="This request will be declined and email sent to sender."-->
<!--                    warning-button="Yes, Decline" loader="true"><i class="ion-ios-close-outline"></i> Decline-->
<!--            </button>-->
<!--        </li>-->
        @else
        @if($document->public_permissions == "sign_edit")
        <form id="payment_form" action="<?= url("Student@viewRoommate").'0'; ?>" method="get">
            <input type="hidden" name="from" value="docsign">
            <input type="hidden" name="csrf-token" value="{{ csrf_token() }}">
        </form>
        <li class="m-o">
            <button class="btn btn-success btn-responsive lease-submit" onclick="document.getElementById('payment_form').submit();"><i class="ion-arrow-graph-up-right"></i> Submit
            </button>
        </li>
        @endif
        <li class="m-o">
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="ion-arrow-down-b"></i>
                    More
                </button>
                <ul class="dropdown-menu public-actions">
                    <li class="m-o">
                        <a class="launch-editor"><i class="ion-edit"></i><span>Sign</span> </a>
                    </li>
                    <li class="divider"></li>
                    <li role="presentation"><a data-toggle="modal" data-target="#updateSignature" data-backdrop="static"
                                               data-keyboard="false"> <i class="ion-edit"></i>
                            <span>Signature</span></a></li>
                    <li class="divider"></li>
                    @if ( env('DISABLE_SHARE') != "Enabled" )
                    <li><a data-toggle="modal" data-target="#sharefile" data-backdrop="static" data-keyboard="false"><i
                                    class="ion-ios-world-outline"></i><span> Share link</span></a></li>
                    <li class="divider"></li>
                    @endif
                    <li><a href="{{ url('') }}uploads/files/{{ $document->filename }}"
                           download="{{ $document->name.'.'.$document->extension }}"><i
                                    class="ion-ios-cloud-download-outline"></i><span> Download</span></a></li>
                </ul>
            </div>
        </li>
        @endif
...
<!--                        <div class="pull-left">-->
<!--                            <button id="prev" class="btn btn-default btn-round"><i class="ion-ios-arrow-left"></i>-->
<!--                            </button>-->
<!--                            <button id="next" class="btn btn-default btn-round"><i class="ion-ios-arrow-right"></i>-->
<!--                            </button>-->
<!--                            <span class="text-muted ml-15">Page <span id="page_num">0</span> of <span-->
<!--                                        id="page_count">0</span></span>-->
<!--                        </div>-->
<!--                        <div class="pull-right">-->
<!--                            <button class="btn btn-default btn-round btn-zoom" zoom="plus"><i class="ion-plus"></i>-->
<!--                            </button>-->
<!--                            <button class="btn btn-default btn-round btn-zoom" zoom="minus"><i class="ion-minus"></i>-->
<!--                            </button>-->
<!---->
<!--                        </div>-->
<!--                    </div>-->
                    ...
                    <div class="document-error">
                        ...
                        <p class="text-muted"><strong>Oops! </strong> <span
                                    class="error-message"> Something went wrong.</span></p>
                    </div>
                    ...
                    @else
                    <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ env("APP_URL") }}/uploads/files/{{ $document->filename }}'
...
<div class="signer-overlay">
    <div class="signer-overlay-header">
        <div class="signer-overlay-logo">
            <a href="<?= url(""); ?>"><img src="<?= url(""); ?>uploads/app/{{ env('APP_LOGO'); }}"
        ...
        <div class="signer-overlay-action">
            ...
            <button class="btn btn-primary signer-save"><i class="ion-ios-checkmark-outline"></i> <span>Submit</span></button>
        </div>
    </div>
    <div class="signer-more-tools" style="display: none;
">
        ...
        <div class="signer-tool" tool="color" action="false" color="#000000">
            <div class="tool-icon tool-colorfill">
                <button id="color-picker"
                        class="jscolor {valueElement:null,value:'000000', borderRadius:'1px', borderColor:'#e6eaee', onFineChange:'updateColor(this)'}"></button>
            </div>
            <p>Color</p>
        </div>
    ...
    <div class="signer-overlay-previewer col-md-8 light-card" style="margin-top: 0"></div>
    <div class="signer-overlay-footer">

        <p class="text-muted text-center"> Powered by <?= env("APP_NAME") ?> | <?= date("Y") ?>
            &copy; <?= env("APP_NAME") ?> | All Rights Reserved. </p>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="foo" class="form-control"
                                   value="{{ env('APP_URL') }}/view/{{ $document->document_key }}"
                                   placeholder="Sharing link" readonly="readonly">
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary copy-link" data-clipboard-action="copy"
                        data-clipboard-target="#foo">Copy Link
                </button>
            </div>
        </div>
...
<div class="modal fade" id="requestFields" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="simcy-front-form" callback="updateRequestFields()" data-parsley-validate="" loader="true"
                  method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="file" name="document-selected-image" class="dropify"
                                       data-parsley-required="true" data-allowed-file-extensions="png jpg jpeg svg gif"
                                       accept="image/*">
                            </div>
                        </div>
                    </div>
...
<?php include 'modal/updateSignature.php'?>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control stamp-color jscolor { valueElement:null,borderRadius:'1px', borderColor:'#e6eaee',value:'000000',zIndex:'99999', onFineChange:'updateStampColor(this)'}"
                                   id="stamp-color" readonly="">
                        </div>
                        <div class="col-md-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="unlock-file" action="" data-parsley-validate="" loader="true" method="POST">
                <div class="modal-body">
                    <div class="alert alert-danger alert-dismissable text-center document-password-error"
                         style="display: none;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="password" class="form-control" name="docpassword"
                                       placeholder="Document Password" data-parsley-required="true">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div id="signature-pad" class="signature-pad">
                                    ...
                                    <div class="signature-pad--footer">
                                        ...
                                        <div class="signature-pad--actions" id="controls">
                                            ...
                                            <div class="signature-tool-item">
                                                <button type="button"
                                                        class="btn btn-primary save-signature edit-signature"></button>
                                            </div>
                                            <!--<div>
...
<div class="right-bar font-list light-card">
    ...
    <div class="right-bar-body">
        <div class="font-list">
            <div class="font-item selected" font="lato" family="'Lato', sans-serif"
                 style="font-family:'Lato', sans-serif;">Lato
            </div>
            <div class="font-item" font="opensans" family="'Open Sans', sans-serif"
                 style="font-family:'Open Sans', sans-serif;">Open Sans
            </div>
            <div class="font-item" font="charmi" family="'Charm', cursive" style="font-family:'Charm', cursive;">Charm
            </div>
            <div class="font-item" font="tajawal" family="'Tajawal', sans-serif"
                 style="font-family:'Tajawal', sans-serif;">Tajawal (Arabic)
            </div>
            <div class="font-item" font="scheherazade" family="'Scheherazade', serif"
                 style="font-family:'Scheherazade', serif;">Scheherazade (Arabic)
            </div>
            <div class="font-item" font="reemkufi" family="'Reem Kufi', sans-serif"
                 style="font-family:'Reem Kufi', sans-serif;">Reem Kufi (Arabic)
            </div>
            <div class="font-item" font="pacificoi" family="'Pacifico', cursive"
                 style="font-family:'Pacifico', cursive;">Pacifico
            </div>
            <div class="font-item" font="b612mono" family="'B612 Mono', monospace"
                 style="font-family:'B612 Mono', monospace;">B612 Mono
            </div>
            <div class="font-item" font="ebgaramond" family="'EB Garamond', serif"
                 style="font-family:'EB Garamond', serif;">EB Garamond
            </div>
        </div>
    </div>
</div>
        ...
        <div class="symbol-list">
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 249.425 249.425"
                     style="enable-background:new 0 0 249.425 249.425;" xml:space="preserve"> <g>
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 52 52;" xml:space="preserve"><g>
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="44.238px" height="44.238px"
                     viewBox="0 0 44.238 44.238" style="enable-background:new 0 0 44.238 44.238;" xml:space="preserve"><g>
                        <g>
                            <g>
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 51.997 51.997"
                     style="enable-background:new 0 0 51.997 51.997;" xml:space="preserve"><path
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 33.875 33.875"
                     style="enable-background:new 0 0 33.875 33.875;" xml:space="preserve"><g>
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 51.997 51.997"
                     style="enable-background:new 0 0 51.997 51.997;" xml:space="preserve"><g>
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="401.998px" height="401.998px"
            ...
            <div class="symbol-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 55.867 55.867;" xml:space="preserve"><path
...
<div class="right-bar shape-list light-card">
    ...
    <div class="right-bar-body">
        <div class="shape-list">
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.285 511.285"
                     style="enable-background:new 0 0 511.285 511.285;" xml:space="preserve"><g>
                        <g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.893 511.893"
                     style="enable-background:new 0 0 511.893 511.893;" xml:space="preserve"><g>
                        <g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 31.494 31.494;" xml:space="preserve"><path style="fill:#1E201D;"
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.01 512.01"
                     style="enable-background:new 0 0 512.01 512.01;" xml:space="preserve"><g>
                        <g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve"><g>
                        <g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 31.49 31.49;" xml:space="preserve"><path style="fill:#1E201D;"
            ...
            <div class="shape-item">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     style="enable-background:new 0 0 42 42;" xml:space="preserve"><rect y="20" width="42" height="2"/>
                    <g></g>
                    <g></g>
                    <g></g>
                    <g></g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.509 511.509"
                     style="enable-background:new 0 0 511.509 511.509;" xml:space="preserve"><g>
                        <g>
            ...
            <div class="shape-item">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.488 511.488"
                     style="enable-background:new 0 0 511.488 511.488;" xml:space="preserve"><g>
                        <g>
